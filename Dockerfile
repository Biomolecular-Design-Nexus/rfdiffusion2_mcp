...
RUN mkdir -p repo && \
    for attempt in 1 2 3; do \
      ...
      git clone --depth 1 --single-branch \
        https://github.com/RosettaCommons/RFdiffusion2.git repo/RFdiffusion2 && break; \
      if [ $attempt -lt 3 ]; then \
        echo "Clone failed, waiting 5 seconds before retry..."; \
        sleep 5; \
      else \
        echo "ERROR: Failed to clone RFdiffusion2 after 3 attempts"; \
        echo "Please check internet connection or visit: https://github.com/RosettaCommons/RFdiffusion2"; \
        exit 1; \
      fi; \
    done && \
